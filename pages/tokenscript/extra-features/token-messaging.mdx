...
5. Run “tokenscript build” to build TSML file or ```tokenscript emulate``` to preview your tokenscript in action 

6. copy file “out/tokenscript.tsml” to some HTTPS hosting and save file URL
